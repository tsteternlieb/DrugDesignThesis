from ..enviroment.utils import permuteAtomToEnd, mol_to_graph_full, permute_mol, bondTypeInt, selfLoop
...
def __remove_edge(mol, atom1_idx, atom2_idx,len_node_actions=16):
